...
SERVER_START_CLASSPATH="${SERVER_START_CLASSPATH};${WEBLOGIC_HOME}/server/lib/weblogic_sp.jar"
SERVER_START_CLASSPATH="${SERVER_START_CLASSPATH};${WEBLOGIC_HOME}/server/lib/weblogic.jar"
