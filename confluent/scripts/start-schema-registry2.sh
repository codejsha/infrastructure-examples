...
SCHEMA_REGISTRY_GC_LOG_OPTS="${SCHEMA_REGISTRY_GC_LOG_OPTS} -Xloggc:${LOG_DIR}/${GC_LOG_FILE_NAME}"
...
# SCHEMA_REGISTRY_GC_LOG_OPTS="-Xlog:gc*:file=${LOG_DIR}/${GC_LOG_FILE_NAME}:time,tags:filecount=10,filesize=100M"
