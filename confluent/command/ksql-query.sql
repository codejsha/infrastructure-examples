...
CREATE STREAM ksql_customers_raw_stream (before CUSTOMERS_STRUCT, after CUSTOMERS_STRUCT, source DBZ_SOURCE_STRUCT, transaction DBZ_TRANSACTION_STRUCT, op VARCHAR, ts_ms BIGINT, ts_us BIGINT, ts_ns BIGINT) WITH (KAFKA_TOPIC='dbserver1.inventory.customers', KEY_FORMAT='JSON', VALUE_FORMAT='JSON', TIMESTAMP='ts_ms');
