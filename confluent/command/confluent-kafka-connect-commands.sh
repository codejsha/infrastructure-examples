...
curl --include --request PUT --header "Accept:application/json" --header "Content-Type:application/json" --data @postgresql-source-temp.json http://localhost:8083/connector-plugins/PostgresqlConnector/config/validate
curl --include --request PUT --header "Accept:application/json" --header "Content-Type:application/json" --data @postgresql-source-temp.json http://kafka-connect1:8083/connector-plugins/PostgresqlConnector/config/validate
...
curl --include --request POST --header "Accept:application/json" --header "Content-Type:application/json" --data @postgresql-source.json http://kafka-connect1:8083/connectors
curl --silent \
    --user kafka-connect:kafka-connect-secret \
    --request POST \
    --header "Accept:application/json" \
...
curl --silent --request GET --header "Accept:application/json" http://kafka-connect1:8083/connectors/postgresql-source | jq

### config
curl --silent --request GET --header "Accept:application/json" http://localhost:8083/connectors/postgresql-source/config | jq
curl --silent --request GET --header "Accept:application/json" http://kafka-connect1:8083/connectors/postgresql-source/config | jq
curl --silent \
    --user kafka-connect:kafka-connect-secret \
    --request GET \
    --header "Accept:application/json" \
...
curl --include --request PUT --header "Accept:application/json" --header "Content-Type:application/json" --data @postgresql-source-temp.json http://kafka-connect1:8083/connectors/postgresql-source/config

### status
curl --silent --request GET --header "Accept:application/json" http://localhost:8083/connectors/postgresql-source/status | jq
curl --silent --request GET --header "Accept:application/json" http://kafka-connect1:8083/connectors/postgresql-source/status | jq

### delete
curl --silent --request DELETE --header "Accept:application/json" http://localhost:8083/connectors/postgresql-source
curl --silent --request DELETE --header "Accept:application/json" http://kafka-connect1:8083/connectors/postgresql-source
curl --silent \
    --user kafka-connect:kafka-connect-secret \
    --request DELETE \
    --header "Accept:application/json" \
...
curl --silent --request GET --header "Accept:application/json" http://kafka-connect1:8083/connectors/postgresql-source/topics | jq
...
curl --silent --request GET --header "Accept:application/json" http://kafka-connect1:8083/connectors/postgresql-source/tasks | jq

curl --silent --request GET --header "Accept:application/json" http://localhost:8083/connectors/postgresql-source/tasks/0 | jq
curl --silent --request GET --header "Accept:application/json" http://kafka-connect1:8083/connectors/postgresql-source/tasks/0 | jq
...
curl --silent --request GET --header "Accept:application/json" http://kafka-connect1:8083/connectors/postgresql-source/tasks/0/status | jq
