...
# New-Machine -VMName "ConfluentNodeMachine0" -VMPath "E:\hyper" -VMProcessor 2 -VMMemory 8GB -Switch "AlphaInternal"
# New-Machine -VMName "ConfluentNodeMachine1" -VMPath "E:\hyper" -VMProcessor 2 -VMMemory 8GB -Switch "AlphaInternal"
# New-Machine -VMName "ConfluentNodeMachine2" -VMPath "E:\hyper" -VMProcessor 2 -VMMemory 8GB -Switch "AlphaInternal"
# New-Machine -VMName "ConfluentNodeMachine3" -VMPath "E:\hyper" -VMProcessor 2 -VMMemory 8GB -Switch "AlphaInternal"
# New-Machine -VMName "ConfluentNodeMachine4" -VMPath "E:\hyper" -VMProcessor 2 -VMMemory 8GB -Switch "AlphaInternal"
# New-Machine -VMName "ConfluentNodeMachine5" -VMPath "E:\hyper" -VMProcessor 2 -VMMemory 8GB -Switch "AlphaInternal"
