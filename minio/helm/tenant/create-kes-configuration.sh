...
kubectl get secret --namespace minio-tenant-1 minio1-client-cert --output jsonpath='{.data.tls\.crt}' | base64 --decode > ${HOME}/.minio/tenant1-client.crt

export MINIO_KES_IDENTITY="$(kes identity of ${HOME}/.minio/tenant1-client.crt | tail -1)"
