...
vault write pki/roles/minio1-console \
...
vault write pki_int/roles/minio1-kes \
    allowed_domains="minio1-kes.example.com,localhost,minio1-kes-hl-svc,*.minio1-kes-hl-svc,minio1-kes-hl-svc.minio-tenant-1,*.minio1-kes-hl-svc.minio-tenant-1,minio1-kes-hl-svc.minio-tenant-1.svc,*.minio1-kes-hl-svc.minio-tenant-1.svc,minio1-kes-hl-svc.minio-tenant-1.svc.cluster.local,*.minio1-kes-hl-svc.minio-tenant-1.svc.cluster.local" \
    allow_subdomains="true" \
    allow_bare_domains="true" \
    allow_glob_domains="true" \
    max_ttl="8760h"
