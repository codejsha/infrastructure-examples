...
Set-IISConfigAttributeValue -ConfigElement $Element -AttributeName "directory" -AttributeValue "SystemDrive%\inetpub\$SiteName\logs\LogFiles"
...
Set-IISConfigAttributeValue -ConfigElement $Element -AttributeName "enabled" -AttributeValue $true
Set-IISConfigAttributeValue -ConfigElement $Element -AttributeName "directory" -AttributeValue "%SystemDrive%\inetpub\$SiteName\logs\FailedReqLogFiles"
