...
# PROMETHEUS_EXPORTER_FILE="${CONFLUENT_HOME}/prometheus/confluent_schemaregistry.yml"
# PROMETHEUS_PORT="1234"
# SCHEMA_REGISTRY_OPTS="${SCHEMA_REGISTRY_OPTS} -javaagent:${PROMETHEUS_JAVA_AGENT_FILE}=${PROMETHEUS_PORT}:${PROMETHEUS_EXPORTER_FILE}"
