...
# mkdir -p /mnt/control-center1/logs
...
# Environment="LOG_DIR=/mnt/control-center1/logs" "CONTROL_CENTER_LOG4J_OPTS=-Dlog4j.configuration=file:/etc/confluent-control-center/log4j-rolling.properties"
