...
function install_kubectl_by_yum {
...
function install_kubectl_specific_version_by_yum {
...
function install_kubectl_by_apt {
...
install_kubectl_by_yum
# install_kubectl_specific_version_by_yum
# install_kubectl_with_download
# install_kubectl_by_apt
